...
class Scrollable(Wrapper, Controller, ControllerManager):
    ...
    def expand(self, width, height):
        if self.content.is_expandable():
            ...
            if self._hscrollbar is not None:
                ...
                self._content_height = height
            self.content.expand(
                max(self._content_width, self.content.width),
    ...
    def hit_test(self, x, y):
        ...
        return (
            y >= self._content_y < self._content_y + self._content_height
            and self._content_x <= x < self._content_x + self._content_width
        )
