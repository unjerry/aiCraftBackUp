...
class TRANS(nn.Module):
    def __init__(self) -> None:
        ...
        self.W_Q2 = nn.Linear(32, 16, bias=False)
        self.W_K2 = nn.Linear(32, 16, bias=False)
        self.W_V_down2 = nn.Linear(32, 16, bias=False)
        self.W_V_up2 = nn.Linear(16, 32, bias=False)

        # self.W_Q3 = nn.Linear(32, 16, bias=False)
        # self.W_K3 = nn.Linear(32, 16, bias=False)
        # self.W_V_down3 = nn.Linear(32, 16, bias=False)
        # self.W_V_up3 = nn.Linear(16, 32, bias=False)
        ...
        self.quesin2 = nn.Parameter(torch.randn([10, 32, 64], requires_grad=True))
        self.quesout2 = nn.Parameter(torch.randn([10, 64, 32], requires_grad=True))
        # self.quesin3 = nn.Parameter(torch.randn([10, 32, 64], requires_grad=True))
        # self.quesout3 = nn.Parameter(torch.randn([10, 64, 32], requires_grad=True))
